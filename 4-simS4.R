#
#  Simulation for Online Supplement, Section \S 4
#  * simulation demonstrating the result of changing the cutoff
#  * use the same setup as Sim 4 (as numbered in code)
#  * change N and prob cut-off
#
library("ggplot2")
library("reshape2")
library("multitaper")
